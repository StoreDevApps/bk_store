...
urlpatterns = [
    ...
    path(
        "products-pagination/",
        viewsCliente.ProductPaginationView.as_view(),
        name="products_pagination",
    ),
    path("products/", views.ListOfProductsView.as_view(), name="products_list"),
    path(
        "product/<int:product_id>/multimedia/",
        views.GetMultimediaProductoView.as_view(),
        name="get_multimedia_producto",
    ),
    path(
    ...
    path(
        ...
        views.AdminCategoriesServicesView.as_view(),
        name="admin_categories_services",
    ),
    path(
        "admin/carousel-images/",
        views.UploadCarouselImageView.as_view(),
        name="carousel_image",
    ),
    path(
        "admin/carousel-image/<int:pk>/",
        views.DeleteCarouselImageView.as_view(),
        name="delete_carousel_image",
    ),
    path("admin/services/", views.AdminServicesView.as_view(), name="admin_services"),
    path(
        "admin/service/<int:pk>/",
        views.AdminServiceView.as_view(),
        name="admin_service",
    ),
    path(
        "admin/list-workers/",
        views.UserWorkerListView.as_view(),
        name="admin_list_workers",
    ),
    path(
        "admin/worker-to-admin/",
        views.WorkerToAdminView.as_view(),
        name="worker_to_admin",
    ),
    path(
        "user/<int:user_id>/", viewsCliente.UserDetailView.as_view(), name="user_detail"
    ),
    path(
        "admin/products/", views.ListadoProductosView.as_view(), name="admin_products"
    ),
    path(
        "admin/product-images/",
        views.ImagenesProductoView.as_view(),
    ...
    path(
        ...
        viewsCliente.ProductDetailView.as_view(),
        name="product-detail",
    ),
    path(
        "products/<int:product_id>/comments/",
        viewsCliente.ProductCommentsView.as_view(),
        name="product-comments",
    ),
    path(
        "products/<int:product_id>/comments/submit",
        viewsCliente.SubmitCommentView.as_view(),
        name="submit-comment",
    ),
    path(
        "products/<int:product_id>/has-purchased",
        viewsCliente.HasPurchasedView.as_view(),
        name="has-purchased",
    ),
    path(
        "products/<int:product_id>/comments/update",
        viewsCliente.UpdateCommentView.as_view(),
        name="update-comment",
    ),
    path(
        "carrito/item-count",
        viewsCliente.CartItemCountView.as_view(),
...
if settings.DEBUG:
    urlpatterns += static(
        "/public/", document_root=os.path.join(settings.BASE_DIR, "public")
    )
