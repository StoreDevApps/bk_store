...
urlpatterns = [
    ...
    path('admin/categories-services/', views.AdminCategoriesServicesView.as_view(), 
         name="admin_categories_services"),
    path('admin/carousel-images/', views.UploadCarouselImageView.as_view(), name="carousel_image"),
    path('admin/carousel-image/<int:pk>/', views.DeleteCarouselImageView.as_view(), 
    ...
    path('products/<int:product_id>/images/', views.DeleteProductImageView.as_view(), 
         name='delete-product-image'),

    path('products/<int:product_id>/', viewsCliente.ProductDetailView.as_view(), 
         name='product-detail'),
    path('products/<int:product_id>/comments/', viewsCliente.ProductCommentsView.as_view(), 
         name='product-comments'),
    path('products/<int:product_id>/comments/submit', viewsCliente.SubmitCommentView.as_view(), 
         name='submit-comment'),
    path('products/<int:product_id>/has-purchased', viewsCliente.HasPurchasedView.as_view(), 
         name='has-purchased'),
    path('products/<int:product_id>/comments/update', viewsCliente.UpdateCommentView.as_view(), 
         name='update-comment'),
    ...
    path('carrito/items/<int:item_id>', viewsCliente.CartItemsView.as_view(), 
