...
class ListOfProductCategoryView(generics.ListCreateAPIView):
    ...
    def get(self, request):
        ...
        return Response({'success': True,'product_categories': product_categories_list}, status=status.HTTP_200_OK)
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({'success': True,'message': 'Categoría creada correctamente'}, status=status.HTTP_201_CREATED)
        except Exception as e:
            print(e)
            return Response({'success': False,'message': 'Error interno del servidor, intente de nuevo'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class ProductCategoryView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get(self, request, pk):
        try:
            ...
            return Response({'success': True,'product_category': {
                'name': product_category.name,
                'id': product_category.id
    ...
    def put(self, request, pk):
        ...
        try:
            ...
            product_category.save()
            return Response({'success': True,'message': 'Categoría actualizada correctamente'}, status=status.HTTP_200_OK)
        except Exception as e:
            print(e)
            return Response({'success': False,'message': 'Error interno del servidor, intente de nuevo'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
